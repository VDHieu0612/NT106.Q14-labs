...
namespace Lab04_Bai04
{
    public partial class Datvephim : Form
    {
        ...
        // Kiểm tra xem dữ liệu nguồn là từ Web hay File Text cũ
        private bool _isWebData = false;
        ...
        private void btnThanhToan_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Vui lòng nhập đủ thông tin và chọn ghế!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
